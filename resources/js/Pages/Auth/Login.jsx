            ...
            <div className="flex flex-col items-center justify-center space-y-8 pb-4 pt-2">
                ...
                <div className="w-full">
                    <button
                        ...
                        className={`w-full flex items-center justify-center space-x-3 px-6 py-3.5 rounded-xl transition-all duration-200 bg-white dark:bg-zinc-800 text-sm font-bold text-zinc-700 dark:text-zinc-200 border border-zinc-200 dark:border-zinc-700 hover:border-gojek-300 dark:hover:border-gojek-700 shadow-sm hover:shadow active:scale-95 ${isVerifying ? "opacity-70 cursor-not-allowed" : ""}`}
                    >
                        {isVerifying ? (
                            <svg className="animate-spin h-5 w-5 text-gojek-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                        ...
                        <span>{isVerifying ? "Mengecek..." : "Lanjut dengan Google"}</span>
                    </button>
                </div>
