...
export default function GuestLayout({ children }) {
    return (
        <div className="flex min-h-screen flex-col items-center bg-zinc-50 dark:bg-zinc-950 pt-6 sm:justify-center sm:pt-0 relative overflow-hidden transition-colors duration-300">
            ...
            <div className="z-10 mt-2 w-full overflow-hidden bg-white/80 dark:bg-zinc-900/80 backdrop-blur-xl px-8 py-10 shadow-2xl shadow-zinc-200/50 dark:shadow-black/50 sm:max-w-md sm:rounded-3xl border border-white/20 dark:border-zinc-800/50">
                {children}
            </div>
